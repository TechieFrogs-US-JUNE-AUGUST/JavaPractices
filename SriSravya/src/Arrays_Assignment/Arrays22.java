...
public class Arrays22 {
    public static void main(String[] args) {
        int a[][]= {{5,6,8},{7,8,6}};                 //a and b matrices should be of equal size for subtraction
        int b[][]= {{1,2,3},{3,4,2}};

        int c[][]= new int[2][3];           //c matrix of 2 rows and 3 columns is used for storing the difference of 2 martices a and b
